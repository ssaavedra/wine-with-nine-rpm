...
# gallium nine patch
Source999:      https://github.com/sarnex/%{name}-d3d9-patches/archive/%{name}-d3d9-%{version}.tar.gz
...
%if 0%{?nine}
gzip -dc %{SOURCE999} | tar -xf - --strip-components=1

patch -p1 < staging-helper.patch
patch -p1 < wine-d3d9.patch
...
%changelog
* Thu Jan 11 2018 Santiago Saavedra <info@ssaavedra.eu> 2.20-1.with_nine
- apply nine patches
